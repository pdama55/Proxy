...
Two limits bound all of this. The environment manufactures the trade-off in order to measure reporting on it,
so these rates say how often the cost of an instruction is conveyed when one exists, not how often such
situations arise unaided; the live-counterparty arm suggests the latter is much rarer. And the principal here
