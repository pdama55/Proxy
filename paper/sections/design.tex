...
\paragraph{Hypotheses and analysis.} The preregistration was frozen in the project repository before any confirmatory episode existed, and is registered on OSF (\preregpointer). The repository commit, not the registration, is the pre-data record: the registration was posted after collection and says so. It specifies:
\begin{itemize}
