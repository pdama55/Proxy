...
\paragraph{Hypotheses and analysis.} The analysis plan was frozen and tagged in the project repository before the first confirmatory episode was generated, and registered afterwards (\preregpointer); we describe it as a frozen analysis plan rather than an independently timestamped preregistration. It was published in full, including the pilot results that run against H2a and H4, and every departure from it is logged in \cref{app:deviations}. It specifies:
\begin{itemize}
