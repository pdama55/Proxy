...
\begin{itemize}
  ...
  \item \textbf{Silent reports.} Reports conveyed the blocked better deal in only a small minority of exposed episodes (judged non-disclosure \doneJudgedAll\ of \exposedCount\ exposed episodes). Only \doneNamedAll\ of reports name the blocked offer at all, so non-disclosure is at least \doneNotNamed\ on mechanical grounds, with no model judgment involved.
